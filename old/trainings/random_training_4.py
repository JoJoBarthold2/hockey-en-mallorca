...
agent.Q.load("more_actions_test_2_150k_30k_(256_256)_nstep_5", "episode_22500")
...
opponents = [opponent0, opponent1, opponent2]
opponents_names = ["Random", "Weak", "NonWeak"]
...
for episode in range(max_episodes):
    ...
    for game in range(games_to_play):
        ...
        if game % int(games_to_play/2) == 0:    
            ...
            print(f"Episode {episode+1}/{max_episodes}, Game {game+1}/{games_to_play} - Total Reward: {total_reward}, Beta: {agent.beta}")
