...
from Dueling_DDQN_Agent.Dueling_DDQN_Agent import Dueling_DDQN_Agent
import Dueling_DDQN_Agent.utils.stats_functions as sf
...
reload(h_env)
env_name = "Dueling_Double_DQN_test_1"
env = h_env.HockeyEnv()
