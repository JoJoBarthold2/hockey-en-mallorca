...
from Agents.Pablo.Dueling_DQN.Agent import Dueling_DQN
...
env_name = "../remake/Dueling_DQN_CartPole"
...
agent = Dueling_DQN(state_space, action_space, seed = seed, update_target_every = 5, batch_size = 64)
