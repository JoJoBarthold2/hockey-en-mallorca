...
from Agents.Pablo.Dueling_Double_DQN.Agent import Dueling_Double_DQN
...
env_name = "../remake/Double_Dueling_DQN_CartPole"
...
agent = Dueling_Double_DQN(state_space, action_space, seed = seed, update_target_every = 5, batch_size = 64)
